...
lang_pairs="tr_TR-en_XX,my_MM-en_XX,ml_IN-en_XX,gl_ES-en_XX,tl_XX-en_XX,te_IN-en_XX,mk_MK-en_XX,pt_XX-en_XX"
path_2_data="data/mbart/set_1/data-bin"
lang_list="models/mbart50-many-to-one/ML50_langs.txt"
pretrained_model="models/mbart50-many-to-one/model_modified.pt"
CHECKPOINTS_DIR="models/many-to-one_XX_to_EN_mod_set-1_por"
