...
lang_list="models/mbart50-many-to-one/ML50_langs.txt"
pretrained_model="models/mbart50-many-to-one/model_fixed.pt"
CHECKPOINTS_DIR="models/mbart50-many-to-one-ft"
...
CUDA_VISIBLE_DEVICES=0,1,2,3  fairseq-train $path_2_data \
  ...
  --validate-interval-updates 5000 --patience 10 --distributed-world-size 4 --distributed-init-method env://
