...
#SBATCH --output=logs/mbart_%j.out
#SBATCH --error=logs/mbart_%j.err
...
lang_pairs="en_XX-pt_XX,en_XX-tr_TR,en_XX-my_MM,en_XX-ml_IN,en_XX-gl_ES,en_XX-tl_XX,en_XX-te_IN,en_XX-mk_MK,tr_TR-en_XX,my_MM-en_XX,ml_IN-en_XX,gl_ES-en_XX,tl_XX-en_XX,te_IN-en_XX,mk_MK-en_XX,pt_XX-en_XX"

path_2_data="data/mbart/data-bin"
lang_list="models/mbart50-many-to-many/ML50_langs.txt"
pretrained_model="models/mbart50-many-to-many/model_fixed.pt"
CHECKPOINTS_DIR="models/mbart50-many-to-many-ft-ALL-to-ALL-por"
